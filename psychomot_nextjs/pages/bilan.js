                ...
                <div className="grid" ref={grid}>
                    <div className="card background shadow">
                        ...
                        <p>Lors du premier rendez-vous, le psychomotricien réalise un entretien qui permet de mieux comprendre la
                            demande initiale en reprenant l’histoire de vie, les différentes étapes du développement, les
                            difficultés rencontrées, les particularités comportementales…
                        </p>
                    </div>
                    <div className="card background shadow">
                        <h2 className="title" data-title="Les tests"></h2>
                        <p> Différents tests et épreuves sont réalisés sur plusieurs séances afin d’évaluer les compétences de la personne dans les différents domaines psychomoteurs : la perception du corps, la motricité globale, la motricité fine et l’écriture, l’organisation dans l’espace et dans le temps, le tonus, la latéralité, le maintien de l’attention… en lien avec les composantes cognitives et psycho-affectives.
                        </p>
                    </div>
                    <div className="card background shadow">
                    ...
                    <div className="card background shadow">
                        ...
                        <p>En fonction des résultats du bilan, peuvent être proposées :</p>
                            <ul className="list">
                            ...
                            <p>une réévaluation pourra être effectuée selon la nécessité.</p>
                    </div>
                </div>
            </div>    
        </Base>
